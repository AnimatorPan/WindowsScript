...
class LibraryListItem(QWidget):
    ...
    def __init__(self, library: LibraryInfo, parent=None):
        ...
        self.setMaximumHeight(50)  # 设置最大高度
        self.setup_ui()
    ...
    def setup_ui(self):
        ...
        path_label.setWordWrap(False)  # 不换行，避免高度问题
...
class WelcomeWindow(QMainWindow):
    ...
    使用 QMainWindow 而不是 QDialog，确保在任务栏显示
    """
    ...
    def load_recent_libraries(self):
        ...
        if libraries:
            ...
            for library in libraries:
                ...
                item.setSizeHint(item_widget.minimumSizeHint())  # 使用最小尺寸提示
